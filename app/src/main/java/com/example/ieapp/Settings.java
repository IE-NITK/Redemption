...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ring = MediaPlayer.create(Settings.this, R.raw.games_of_part_4);
        play.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (ring.isPlaying()) {
                                            ring.pause();
                                            play.setBackgroundResource(R.drawable.volonimg);
                                        } else {
                                            ring.start();
                                            play.setBackgroundResource(R.drawable.voloffimg);
                                        }
